...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_PROJECTOR_0,                             "projector.0.weight" },
    { LLM_TENSOR_PROJECTOR_2,                             "projector.2.weight" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_PROJECTOR_0,                {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_MUL_MAT}},
    {LLM_TENSOR_PROJECTOR_2,                {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_MUL_MAT}},
